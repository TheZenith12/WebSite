  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-4 rounded shadow">
        ...
        <input name="name" placeholder="Нэр" value={form.name}
          onChange={handleChange} className="border w-full px-3 py-2 rounded" />

        <textarea name="description" placeholder="Тайлбар" value={form.description}
          onChange={handleChange} className="border w-full px-3 py-2 rounded" />
        ...
        <input name="location" placeholder="Байршил" value={form.location}
          onChange={handleChange} className="border w-full px-3 py-2 rounded" />

        <input name="price" type="number" placeholder="Үнэ" value={form.price}
          onChange={handleChange} className="border w-full px-3 py-2 rounded" />

        {/* Images */}
        <div>
          <label className="font-medium">🖼️ Олон зураг</label>
